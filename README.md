...
```mermaid
graph TD
    User["User"] -->|1. Connects Wallet| App["Frontend (React)"]
    App -->|2. Requests Tokens| Node["Local Blockchain"]
    Node -->|3. Executes| Faucet["Faucet Contract"]
    Faucet -->|4. Transfers| Token["ERC-20 Token"]
```
